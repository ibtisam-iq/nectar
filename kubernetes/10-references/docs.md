...
- ports, network plugins, etcd, static pod, ingress, gateapi, netpol, probe, security context, Sidecar Containers, Init Containers (Creating a Pod that has an init container) 
