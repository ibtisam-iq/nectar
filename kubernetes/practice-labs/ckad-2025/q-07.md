# **📌 Q-7 — RBAC Fix Using Logs (ServiceAccount + Role/RoleBinding Problem)**
...
### **Trap-1 — Logs contain VERY old entries**

Exam clusters run workloads for days → logs are full of junk.
Always use:
...
### **Trap-2 — The log tells you EXACTLY:**
...
| Resource        | **pods**                            |
| Verb            | **list**                            |
| Level           | **Namespaced** → Role + RoleBinding |

If it said **cluster**, then you would need ClusterRoleBinding.

---

### **Trap-3 — They already gave multiple Roles + RoleBindings**
...
### **Trap-4 — The Deployment’s command reveals more**
...
* Required verbs → **list**
* Required resources → **pods, secrets**
* Required scope → **namespaced**

---

### **Trap-5 — After fixing RBAC, Pods do NOT auto-restart**
...
# 🧪 **FULL LAB SETUP (Everything exam provides)**
...
→ SA = default
→ Must be changed to **gorilla**

---

# 🎯 **STEP-BY-STEP SOLUTION (Format-1)**
...
Now you see real output — **no RBAC errors**.
