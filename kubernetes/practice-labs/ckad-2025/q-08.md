...
2. **Three Role manifest files** located in:
   ...
   * verbs: (`get`, `list`)
3. **No RoleBindings are provided** — you must create one.
4. The question explicitly states:

   * *“Do NOT modify any of the provided Role manifest files.”*
...
## ⭐ **Step 2 — Inspect the three provided Roles**
...
* Resource = `pods`
* Verbs = `get`, `list`
* Scope is namespaced → matches error message
...
## **Step 4 — Patch the Deployment to Use This ServiceAccount**

Two valid methods:

### **Method A — Imperative (Fastest for CKAD)**

```bash
kubectl set serviceaccount deployment/mydeploy panther -n analytics
```

### **Method B — kubectl edit**
...
## **Step 5 — Restart Pods so RBAC Takes Effect**
