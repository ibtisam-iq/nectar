[installation](https://docs.docker.com/compose/install/linux/)
...
Edit
docker-compose down
To rebuild containers when modifying the Dockerfile:
sh
Copy
Edit
...
For Docker Compose v2 (latest & recommended):

sh
Copy
Edit
docker compose up -d
No hyphen (-) between docker and compose.
This is the default in Docker CLI since Docker 20.10+.
