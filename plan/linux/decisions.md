...
| D9 | The plan is logged in `plan/` and merged first; `CLAUDE.md`, `GEMINI.md` and a new `AGENTS.md` point to it | Any LLM working in the repository must read the plan and standards before writing a tool folder |
