...
| Git | `delivery/git/` | [`git/plan.md`](git/plan.md) | Phase 3 batches A and B done (modules 00, 01, 03), lint and `--scope B --build` clean; awaiting owner review; batches C to E next |
