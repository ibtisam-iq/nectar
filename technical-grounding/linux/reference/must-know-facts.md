...
--8<-- "technical-grounding/linux/04-users-and-access/users.md:facts"

### Groups

--8<-- "technical-grounding/linux/04-users-and-access/groups.md:facts"

### Passwords and Aging

--8<-- "technical-grounding/linux/04-users-and-access/passwords-and-aging.md:facts"

### Sudo and Su

--8<-- "technical-grounding/linux/04-users-and-access/sudo-and-su.md:facts"

### PAM

--8<-- "technical-grounding/linux/04-users-and-access/pam.md:facts"

### Login Sessions

--8<-- "technical-grounding/linux/04-users-and-access/login-sessions.md:facts"
